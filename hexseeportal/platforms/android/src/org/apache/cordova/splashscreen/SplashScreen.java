...
import com.groupsurfing.hexsee.DeviceJson;
import com.groupsurfing.hexsee.MainActivity;
import com.groupsurfing.hexsee.R;
...
public class SplashScreen extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (action.equals("hide")) {
            ...
            Log.e("TESTTTT:", "show show show show");
            cordova.getActivity().runOnUiThread(new Runnable() {
                public void run() {
        ...
        }   else if (action.equals("savePreferences")) {
            // SharedPreferences sp = PreferenceManager
            // 		.getDefaultSharedPreferences(cordova.getActivity()
            // 				.getApplicationContext());
            // Editor editor = sp.edit();
            // editor.putString(PREFERENCE_GAMES, makeJsonPreferenceGame(args));
            // editor.commit();
            return true;
    ...
    private String getDeviceID() {
        TelephonyManager phonyManager= (TelephonyManager)cordova.getActivity().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private String getDeviceInfo(){
        ...
        deviceJson.setAppVersion(String.valueOf(packageInfo.versionName));
        deviceJson.setDeviceId(getDeviceID());
        deviceJson.setDeviceType(myDeviceModel);
        deviceJson.setOsVersion(String.valueOf(android.os.Build.VERSION.RELEASE ));
        deviceJson.setInstallationId(ParseInstallation.getCurrentInstallation().getInstallationId());
        Gson gson = new Gson();
        String json =gson.toJson(deviceJson);
        return json;
    }
    @Override
